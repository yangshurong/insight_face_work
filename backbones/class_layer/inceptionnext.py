...
class InceptionDWConv2d(nn.Module):
    ...
    def __init__(self, in_channels, square_kernel_size=3, band_kernel_size=11, branch_ratio=0.125):
        ...
        self.dwconv_w = nn.Conv2d(gc, gc, kernel_size=(
            1, band_kernel_size), padding=(0, band_kernel_size//2), groups=gc)
        self.dwconv_h = nn.Conv2d(gc, gc, kernel_size=(
            band_kernel_size, 1), padding=(band_kernel_size//2, 0), groups=gc)
...
class MetaNeXt(nn.Module):
    ...
    def __init__(
        ...
        self.out_num_features = prev_chs
        # print('out_num_features', self.out_num_features)
...
def inceptionnext_small(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        print('finish load pretrain for inceptionnext_small')
    return model
